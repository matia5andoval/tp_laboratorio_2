...
namespace TP_02_2018
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Nombre del alumno
            Console.Title = "Matias Sandoval 2A";
            ...
            // Muestro solo Moto
            Console.WriteLine(Taller.Mostrar(taller, Taller.ETipo.Ciclomotor));
            Console.WriteLine("<-----------PRESIONE UNA TECLA PARA CONTINUAR----------->");
            Console.ReadKey();
            Console.Clear();

            // Muestro solo Automovil
            Console.WriteLine(Taller.Mostrar(taller, Taller.ETipo.Sedan));
            Console.WriteLine("<-----------PRESIONE UNA TECLA PARA CONTINUAR----------->");
            Console.ReadKey();
            Console.Clear();

            // Muestro solo Camioneta
            Console.WriteLine(Taller.Mostrar(taller, Taller.ETipo.Suv));
